if(NOT BNFC_FOUND)
  ...
  if(BNFC_EXECUTABLE)
    ...
    macro(BNFC_TARGET_CSHARP Name BNFCInput BNFCOutputFolder)
      ...
      set(BNFC_TARGET_CSHARP_PARAM_MULTI_VALUE_KEYWORDS)
      cmake_parse_arguments(
        BNFC_TARGET_CSHARP_ARG "${BNFC_TARGET_CSHARP_PARAM_OPTIONS}"
        "${BNFC_TARGET_CSHARP_PARAM_ONE_VALUE_KEYWORDS}"
        "${BNFC_TARGET_CSHARP_PARAM_MULTI_VALUE_KEYWORDS}" ${ARGN})
